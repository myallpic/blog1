(function() {
    ...
    var Ja = function(a, b, c, d) {
      ...
      , Ma = function(a, b, c) {
        p(a) || Ja("Expected string but got %s: %s.", [qa(a), a], b, Array.prototype.slice.call(arguments, 2));
        return a
    }
      , Na = function(a, b, c) {
        ...
        for (var c = 0, d = db(String(a)).split("."), e = db(String(b)).split("."), f = Math.max(d.length, e.length), h = 0; 0 == c && h < f; h++) {
            ...
            do {
                ...
                if (0 == k[0].length && 0 == m[0].length)
                    break;
                c = nb(0 == k[1].length ? 0 : parseInt(k[1], 10), 0 == m[1].length ? 0 : parseInt(m[1], 10)) || nb(0 == k[2].length, 0 == m[2].length) || nb(k[2], m[2]);
                k = k[3];
                m = m[3]
            } while (0 == c)
        }
    ...
    var Kb = v("Opera"), w = Ab(), Lb = v("Edge"), Mb = Lb || w, z = v("Gecko") && !(-1 != rb.toLowerCase().indexOf("webkit") && !v("Edge")) && !(v("Trident") || v("MSIE")) && !v("Edge"), A = -1 != rb.toLowerCase().indexOf("webkit") && !v("Edge"), Nb = v("Macintosh"), Ob = v("Windows"), Pb = v("Android"), Qb = Eb(), Rb = v("iPad"), Sb = v("iPod"), Tb = Fb(), Ub = function() {
        var a = l.document;
    ...
    var D = function(a) {
      ...
      , Gc = function(a, b, c, d) {
        ...
        if (c) {
            ...
            for (f = e = 0; h = a[f]; f++)
                b = h.className,
                "function" == typeof b.split && $a(b.split(/\s+/), c) && (d[e++] = h);
            d.length = e;
            return d
        }
        return a
      ...
      , Jc = function(a, b) {
        ub(b, function(b, d) {
            ...
            "style" == d ? a.style.cssText = b : "class" == d ? a.className = b : "for" == d ? a.htmlFor = b : Ic.hasOwnProperty(d) ? a.setAttribute(Ic[d], b) : 0 == d.lastIndexOf("aria-", 0) || 0 == d.lastIndexOf("data-", 0) ? a.setAttribute(d, b) : a[d] = b
        })
    }
      , Ic = {
    ...
    var bd = !w || bc(9)
      ...
      , ed = function() {
        ...
        try {
            l.addEventListener("test", pa, b),
            l.removeEventListener("test", pa, b)
        } catch (c) {}
        return a
    }();
    var fd = function(a) {
    ...
    ;
    g.translate = function(a, b) {
        a instanceof B ? (this.left += a.x,
        this.right += a.x,
        this.top += a.y,
        this.bottom += a.y) : (La(a),
        this.left += a,
        this.right += a,
        oa(b) && (this.top += b,
        this.bottom += b));
    ...
    var ld = function(a, b, c) {
      ...
      , kd = function(a, b) {
        ...
        if (!c) {
            var d = pb(b);
            c = d;
            void 0 === a.style[d] && (d = (A ? "Webkit" : z ? "Moz" : w ? "ms" : Kb ? "O" : null) + qb(d),
      ...
      , rd = function(a) {
        ...
        w && a.ownerDocument.body && (a = a.ownerDocument,
      ...
      , ud = function(a) {
        for (var b = new id(0,Infinity,Infinity,0), c = D(a), d = c.f.body, e = c.f.documentElement, f = Mc(c.f); a = sd(a); )
            if (!(w && 0 == a.clientWidth || A && 0 == a.clientHeight && a == d) && a != d && a != e && "visible" != nd(a, "overflow")) {
                var h = td(a)
      ...
      , wd = function(a) {
        var b = a.offsetWidth
          , c = a.offsetHeight
          , d = A && !b && !c;
        return n(b) && !d || !a.getBoundingClientRect ? new Ec(b,c) : (a = rd(a),
        new Ec(a.right - a.left,a.bottom - a.top))
    }
      , yd = function(a, b) {
        u(a);
        var c = a.style;
    ...
    var L = {
        ...
        Ti: function(a, b, c) {
            return L.contains(a, b) ? (L.remove(a, b),
            L.add(a, c),
            !0) : !1
        },
        toggle: function(a, b) {
    ...
    ce.prototype.aa = function(a, b) {
        ...
        this.screenY = d.screenY || 0) : (this.offsetX = A || void 0 !== a.offsetX ? a.offsetX : a.layerX,
        ...
        this.pointerType = p(a.pointerType) ? a.pointerType : ee[a.pointerType] || "";
        this.state = a.state;
        this.ja = a;
    ...
    ke.prototype.add = function(a, b, c, d, e) {
        ...
        var h = le(a, b, d, e);
        -1 < h ? (b = a[h],
        c || (b.dc = !1)) : (b = new ie(b,this.src,f,!!d,e),
        b.dc = c,
        a.push(b));
        return b
    }
    ...
    var ne = "closure_lm_" + (1E6 * Math.random() | 0)
      ...
      , se = function(a, b, c, d, e, f) {
        ...
        if (a.addEventListener)
            ...
            u("change" === b, "MediaQueryList only has a change event"),
            a.addListener(d);
        else
      ...
      , qe = function(a, b, c, d, e) {
        ...
        c = re(c);
        return ge(a) ? a.xd(b, c, ua(d) ? !!d.capture : !!d, e) : se(a, b, c, !0, d, e)
    }
      , xe = function(a, b, c, d, e) {
        if (ra(b))
            ...
            d = ua(d) ? !!d.capture : !!d,
            c = re(c),
            ge(a) ? a.Zb(b, c, d, e) : a && (a = te(a)) && (b = a.Hb(b, c, d, e)) && Q(b)
    }
      , Q = function(a) {
        if (oa(a) || !a || a.vb)
            return !1;
        ...
        if (!cd) {
            ...
            if (!(0 > e.keyCode || void 0 != e.returnValue)) {
                ...
                for (f = c.currentTarget; f; f = f.parentNode)
                    e.push(f);
                f = a.type;
                for (var h = e.length - 1; !c.Ya && 0 <= h; h--) {
                    c.currentTarget = e[h];
                    var k = ze(e[h], f, !0, c);
                    d = d && k
                }
    ...
    De.prototype.Zb = function(a, b, c, d, e) {
        if (ra(b))
            ...
            c = re(c),
            d = !!d,
            b = ge(a) ? a.Hb(b, c, d, e) : a ? (a = te(a)) ? a.Hb(b, c, d, e) : null : null,
            b && (Q(b),
            delete this.s[b.key]);
        return this
    }
    ...
    Me.prototype.add = function(a, b) {
        var c = Oe.get();
        c.set(a, b);
        this.Uc ? this.Uc.next = c : (u(!this.ab),
        this.ab = c);
        this.Uc = c
    }
    ;
    ...
    var Te = function(a, b) {
        ...
        if (l.Promise && l.Promise.resolve) {
            ...
            Pe = function() {
                var a = Ue;
                !ta(l.setImmediate) || l.Window && l.Window.prototype && !v("Edge") && l.Window.prototype.setImmediate == l.setImmediate ? (Ke || (Ke = Le()),
                Ke(a)) : l.setImmediate(a)
            }
    }, Re = !1, Se = new Me, Ue = function() {
    ...
    var gf = function(a, b) {
        if (0 == a.X)
            if (a.A) {
                var c = a.A;
                if (c.na) {
                    for (var d = 0, e = null, f = null, h = c.na; h && (h.bc || (d++,
                    h.Ha == a && (e = h),
                    !(e && 1 < d))); h = h.next)
                        e || (f = h);
                    e && (0 == c.X && 1 == d ? gf(c, b) : (f ? (d = f,
                    u(c.na),
                    u(null != d),
                    d.next == c.gb && (c.gb = d),
                    d.next = d.next.next) : hf(c),
                    jf(c, e, 3, b)))
                }
                a.A = null
            } else
    ...
    var Ve = function(a, b, c) {
        ...
        a.X = 1,
        bf(c, a.Kg, a.Lg, a) || (a.Oe = c,
        a.X = b,
        a.A = null,
        kf(a),
        3 != b || c instanceof We || mf(a, c)))
    }
      , bf = function(a, b, c, d) {
        if (a instanceof T)
            return null != b && Na(b, "opt_onFulfilled should be a function."),
            null != c && Na(c, "opt_onRejected should be a function. Did you pass opt_context as the second argument instead of the third?"),
            lf(a, Ze(b || pa, c || null, d)),
            !0;
        if (a)
            try {
    ...
    var Hf = function(a) {
        ...
        try {
            ...
            U(this.a, "There was an error initializing the collapsed header. Uncaught exception.", d),
            this.b()
        }
    };
    Hf.prototype.Zf = function() {
        ...
        this.vd = Nc(document).y;
        b = this.vd < b;
        0 > this.Ye.getBoundingClientRect().top && b ? this.Id || (this.Mb && (J in this.o && R(this.o, J),
        this.Mb = !1),
        this.Id = !0,
        L.add(document.body, "collapsed-header"),
        L.contains(this.Z, "cloned") || (L.add(this.Z, "cloned"),
        this.Z.appendChild(this.Cf)),
        L.add(this.o, "sticky"),
        L.remove(this.o, "animating"),
        If(this),
        setTimeout(function() {
            L.add(a.o, "animating");
            Ff(a.o, 0);
        ...
        document.body.appendChild(this.o)) : (this.Id = !1,
        L.contains(this.Z, "cloned") && (If(this),
        J ? P(this.o, J, this.se, !1, this) : setTimeout(function() {
            return a.se()
        }, this.hc.Rf),
        this.Mb = !0))
    }
    ...
    Hf.prototype.se = function() {
        this.Mb && (this.o.style.transform = "",
        this.o.style.opacity = "",
        J && R(this.o, J),
        this.Mb = !1,
        this.Z.parentNode.insertBefore(this.o, this.Z),
        L.remove(document.body, "collapsed-header"),
        L.contains(this.Z, "cloned") && (L.remove(this.Z, "cloned"),
        this.Z.removeChild(this.Z.lastChild)),
        L.remove(this.o, "sticky"),
        Ae("collapsed-header-hide", new Jf("collapsed-header-hide")))
    }
    ;
    ...
    var Gf = function(a) {
      ...
      , Kf = function(a, b, c, d) {
        ...
        if (e) {
            ...
            rf && d && window.history.pushState({}, document.title, window.location.pathname + b)
        }
        return !!e
    }
      , Lf = function(a, b) {
    ...
    Hf.prototype.b = function() {
        this.Vb && (xe(window, "scroll", this.Vb),
        this.Vb = null)
    }
    ;
    var Jf = function(a, b) {
    ...
    var Qf = function(a, b, c, d, e, f) {
      ...
      , Of = function(a) {
        if (48 <= a && 57 >= a || 96 <= a && 106 >= a || 65 <= a && 90 >= a || (A || Lb) && 0 == a)
            return !0;
        switch (a) {
        case 32:
        case 43:
    ...
    var $f = function(a) {
        ...
        for (var b = [], c, d = 0; c = a[d]; d++) {
            ...
            for (var k, m = 0; k = e[m]; m++) {
                ...
                h = Wf[f];
                La(h, "Key name not found in goog.events.KeyNames: " + k);
                f = k;
                break
            }
            b.push({
    ...
    Vf.prototype.me = function(a) {
        z && (32 == this.Yc && 32 == a.keyCode && a.preventDefault(),
        this.Yc = null);
    ...
    Vf.prototype.Jb = function(a) {
        a: {
            ...
            b = !d && !e || this.Of[b] || this.vf ? !0 : e ? !1 : this.ag && (a.altKey || a.ctrlKey || a.metaKey) ? !0 : "INPUT" == c.tagName && this.Ig[c.type] ? 13 == b : "INPUT" == c.tagName || "BUTTON" == c.tagName ? this.wf ? !0 : 32 != b : !1
        }
        if (b)
            if ("keydown" == a.type && Ob && a.ctrlKey && a.altKey)
                ...
                if (!d || 1500 <= Da() - this.zc)
                    this.Fb = this.Tb,
                    this.zc = Da();
                (d = bg(this.Fb, c)) && d.next && (this.Fb = d.next,
                this.zc = Da());
                d && (d.next ? a.preventDefault() : (this.Fb = this.Tb,
                this.zc = Da(),
                this.xf && a.preventDefault(),
                this.yf && a.stopPropagation(),
                c = Ma(d.We, "A terminal node must have a string shortcut identifier."),
                d = a.target,
                e = this.dispatchEvent(new cg("shortcut",c,d)),
                (e &= this.dispatchEvent(new cg("shortcut_" + c,c,d))) || a.preventDefault(),
                z && (this.Yc = b)))
            }
    }
    ;
        ...
        try {
            if (this.Eb = document.querySelector(".centered-top-container")) {
                ...
                if (c) {
                    ...
                    (this.Za = d && Array.prototype.slice.call(d, 0)) && 0 != this.Za.length ? (this.Sb = this.Eb.querySelector(".search-close"),
                    this.G = b && Nf(this.Ea, function() {
                        return a.Pd()
                    }) || null,
                    (this.dd = this.Eb.querySelector(".centered-top")) ? (this.Qe = this.Ea.querySelector(".search-action"),
                    (this.$a = this.Ea.querySelector(".search-input input")) ? (this.ze = new Vf(document),
                    dg(this),
                    V(this.a, "Finished initializing search section.")) : U(this.a, "There was an error initializing the search section. search input not found.")) : U(this.a, "There was an error initializing the search section. centered-top not found.")) : sf(this.a, "There was an error initializing the search section. No search buttons found.")
                } else
                    U(this.a, "There was an error initializing the search section. search section not found.")
            } else
                U(this.a, "There was an error initializing the search section. container not found.")
        } catch (e) {
            U(this.a, "Error initializing section. Uncaught exception.", e),
            this.b()
        }
    }
      , dg = function(a) {
    ...
    eg.prototype.Pd = function() {
        L.contains(this.Ea, "focused") ? L.contains(this.Ea, "focused") && (L.remove(this.Ea, "focused"),
        L.remove(this.dd, "search-focused"),
        this.G && this.G.Lb()) : this.ke()
    }
    ;
    eg.prototype.ke = function() {
        L.contains(this.Ea, "focused") || (L.add(this.dd, "search-focused"),
        L.add(this.Ea, "focused"),
        this.G && this.G.show());
        this.$a.focus()
    }
    ;
    eg.prototype.b = function() {
        ...
        this.Sb && (R(this.Sb, "click"),
        this.Sb = null);
        this.$a && (R(this.$a, "input"),
        this.$a = null)
    }
    ;
    var fg = function() {};
    ...
    var gg = function() {
        ...
        return Nb ? (a = /10[_.][0-9_.]+/,
        (a = a.exec(rb)) ? a[0].replace(/_/g, ".") : "10") : Pb ? (a = /Android\s+([^\);]+)(\)|;)/,
        (a = a.exec(rb)) ? a[1] : "") : Qb || Rb || Sb ? (a = /(?:iPhone|CPU)\s+OS\s+(\S+)/,
        (a = a.exec(rb)) ? a[1].replace(/_/g, ".") : "") : ""
    }();
    var jg = function(a, b, c, d, e, f, h, k, m) {
        ...
        if (x = ud(a)) {
            var O = new jd(x.left,x.top,x.right - x.left,x.bottom - x.top);
            x = Math.max(y.left, O.left);
            E = Math.min(y.left + y.width, O.left + O.width);
            x <= E && (M = Math.max(y.top, O.top),
            O = Math.min(y.top + y.height, O.top + O.height),
            M <= O && (y.left = x,
            y.top = M,
            y.width = E - x,
            y.height = O - M))
      ...
      , ig = function(a, b, c, d, e, f, h) {
        ...
        if (f) {
            if (e) {
                ...
                if (f & 16) {
                    ...
                    m |= 4);
                    d.x + k.width > e.right && (k.width = Math.min(e.right - d.x, r + k.width - e.left),
                ...
                d.y < e.top && (d.y = e.top,
                m |= 8),
                d.y + k.height > e.bottom && (k.height = Math.min(e.bottom - d.y, r + k.height - e.top),
        ...
        h = C(b),
        a = Kc(D(h).f),
        !w || $b("10") || a && $b("8") ? (b = b.style,
        z ? b.MozBoxSizing = "border-box" : A ? b.WebkitBoxSizing = "border-box" : b.boxSizing = "border-box",
        b.width = Math.max(c.width, 0) + "px",
        b.height = Math.max(c.height, 0) + "px") : (h = b.style,
        a ? (w ? (a = Bd(b, "paddingLeft"),
        f = Bd(b, "paddingRight"),
        d = Bd(b, "paddingTop"),
        k = Bd(b, "paddingBottom"),
        a = new id(d,f,k,a)) : (a = G(b, "paddingLeft"),
        f = G(b, "paddingRight"),
        d = G(b, "paddingTop"),
        k = G(b, "paddingBottom"),
        a = new id(parseFloat(d),parseFloat(f),parseFloat(k),parseFloat(a))),
        b = Fd(b),
    ...
    var og = function(a, b) {
        b ? (u(wb(ng, b), "No such ARIA role " + b),
    ...
    ug.prototype.remove = function(a) {
        return Object.prototype.hasOwnProperty.call(this.la, a) ? (delete this.la[a],
        this.ib--,
        this.$b++,
        this.s.length > 2 * this.ib && vg(this),
        !0) : !1
    }
    ;
    var vg = function(a) {
        ...
        if (a.ib != a.s.length) {
            ...
            for (c = b = 0; b < a.s.length; )
                d = a.s[b],
                Object.prototype.hasOwnProperty.call(e, d) || (a.s[c++] = d,
                e[d] = 1),
                b++;
            a.s.length = c
        }
    ...
    ;
    g.set = function(a, b) {
        Object.prototype.hasOwnProperty.call(this.la, a) || (this.ib++,
        this.s.push(a),
        this.$b++);
        this.la[a] = b
    }
    ...
    g.Hd = function() {
        if (!this.qb && this.dispatchEvent("beforeshow")) {
            ...
            if (this.Yd)
                if (this.O.w(a, "mousedown", this.Ee, !0),
                w) {
                    try {
                    ...
                    this.O.w(a, "blur", this.De);
            "toggle_display" == this.Ab ? (this.c.style.visibility = "visible",
            I(this.c, !0)) : "move_offscreen" == this.Ab && this.L();
            this.qb = !0;
            this.wd = Da();
            this.yb ? (qe(this.yb, "end", this.Va, !1, this),
            this.yb.play()) : this.Va()
        }
    }
    ;
    g.pb = function(a) {
        ...
        this.qb = !1;
        Da();
        this.ob ? (qe(this.ob, "end", Ca(this.de, a), !1, this),
        this.ob.play()) : this.de(a);
        return !0
    }
    ;
    g.de = function(a) {
    ...
    ;
    g.hg = function(a) {
        27 == a.keyCode && this.pb(a.target) && (a.preventDefault(),
        a.stopPropagation())
    }
    ;
    g.De = function(a) {
    ...
    var Ig = function() {
        ...
        try {
            if (this.Bf = void 0,
            this.j = document.body && Nf(document.body, null, "subscribe-dim-overlay"),
            this.o = document.querySelector(".centered-top-container"))
                if (this.J = this.o.querySelector(".subscribe-popup"))
                    if (this.l = new Gg(this.J),
                    this.Nd = this.o.querySelector(".subscribe-popup-container"))
                        if (this.Ub = this.o.querySelector(".subscribe-button"))
                            if (this.sa = this.J.querySelector(".follow-by-email-address")) {
                                if (this.kb = this.J.querySelector(".follow-by-email-submit"))
                                    P(this.sa, "input", this.hf, !1, this),
                                    Hg(this, !0),
                                    this.hf(),
                                    this.Fd(),
                                    V(this.a, "Finished initializing Subscribe.")
                            } else
            ...
            U(this.a, "Error initializing Subscribe. Uncaught exception.", a),
            this.b()
        }
    };
    Ig.prototype.hf = function() {
        ...
        if (b = "" != this.sa.value)
            (a = a && this.sa.validity.valid) || (a = new xg,
            a.Cb = this.sa.value.trim(),
            a = Ag.test(a.Cb)),
            b = a;
        Hg(this, !b)
    }
    ...
    var Og = function(a) {
        ...
        try {
            ...
            U(this.a, "Error initializing overflow detector. Uncaught exception.", d),
            this.b()
        }
    }
      , Pg = function(a, b) {
    ...
    Sg.prototype.L = function(a, b, c, d) {
        ...
        if (e & 496) {
            ...
            e & 496 && (f = Tg(e, f),
            b = Tg(e, b),
            jg(this.element, f, a, b, null, c, this.Vf, d, this.zd))
        }
    }
    ;
    var Tg = function(a, b) {
    ...
    Ug.prototype.aa = function() {
        ...
        try {
            ...
            if (!this.Ia)
                return U(this.a, "There was an error initializing an overflowable. content element not found."),
                af();
            this.xa = F(this.i.Zd, this.ha);
            this.bd = Vg(this);
            Wc(this.bd, this.Ia);
            L.contains(this.ha, "overflowable-no-popup") || (this.Y = document.createElement("DIV"),
            L.add(this.Y, "overflow-popup"),
            I(this.Y, !1),
            Wc(this.Y, this.ha));
            ...
            return U(this.a, "Error initializing overflowable. Uncaught exception.", c),
            af(c)
        }
    }
    ;
    ...
    Ug.prototype.Fd = function() {
        var a = this;
        this.xa && this.Y && (this.Y.innerHTML = this.Ia.innerHTML,
        this.l = new Gg(this.Y),
        Eg(this.l),
        Dg(this.l),
        this.cc = P(this.xa, "click", function(b) {
            a.xb();
            b.preventDefault()
        }),
    ...
    var Yg = function() {
        ...
        try {
            this.bind(),
            V(this.a, "Finished initializing ripple effects.")
        } catch (b) {
    ...
    function ch(a) {
        return bh ? $e(bh[a]) : ah().then(function() {
            var b = _WidgetManager._GetAllData(), c = {}, d;
            for (d in b)
                c[d] = b[d];
            bh = c;
            return bh[a]
    ...
    hh.prototype.aa = function() {
        ...
        try {
            ...
            if (1 != a.length)
                return U(this.a, "Collapsible did not contain exactly one details element."),
                $e();
            this.v = a[0];
            var b = (this.v || document).getElementsByTagName("SUMMARY");
            if (1 != b.length)
                return U(this.a, "Collapsible did not contain exactly one summary element."),
                $e();
            this.Fa = b[0];
            this.Gb = "b-details-" + ya(this.v);
            Kd() || (this.v.id = this.Gb,
            og(this.Fa, "button"),
            W(this.Fa, "controls", this.Gb),
            W(this.v, "expanded", !1),
            W(this.Fa, "expanded", !1),
            bb(document.querySelectorAll("#" + this.Gb + " > :not(summary)")).forEach(function(a) {
                return W(a, "hidden", !0)
            }));
            this.Od = P(this.Fa, "click", this.Pc, !1, this)
        } catch (c) {
            return U(this.a, "Error initializing collapsible. Uncaught exception.", c),
    ...
    hh.prototype.Pc = function(a) {
        ...
        Kd() || (this.v && rg(this.v, "expanded"),
        this.Fa && rg(this.Fa, "expanded"),
        bb(document.querySelectorAll("#" + this.Gb + " > :not(summary)")).forEach(function(a) {
            return rg(a, "hidden")
        }))
    }
    ...
    var jh = function(a, b, c) {
        ...
        try {
            ...
            this.Mc = b,
            this.wb = c ? c : null,
            P(b, "click", this.Pc, !1, this),
            c && P(c, "click", this.Pc, !1, this)
        } catch (d) {
            U(this.a, "Error initializing extendable. Uncaught exception.", d),
            this.b()
        }
    ...
    jh.prototype.Pc = function() {
        ...
        if (L.contains(this.H, "expanded"))
            J && (R(this.H, J),
            H(this.H, G(this.H, "height")),
            setTimeout(function() {
                H(a.H, 0)
            }, 0)),
            L.remove(this.H, "expanded"),
            L.remove(this.Mc, "hidden"),
            this.wb && L.add(this.wb, "hidden");
        else {
            H(this.H, "auto");
            if (J) {
    ...
    ph.prototype.V = function() {
        this.Da && (this.Da.parentNode.removeChild(this.Da),
        this.Da = null)
    }
    ;
    ...
    var uh = function() {
        ...
        b && c && window.addEventListener && (sh(b) || this.W || (this.W = th(),
        this.W.show()),
        this.od = P(b, "iframeMoved", function() {
            a.W && a.W.V();
            a.W = th();
            a.W.show();
        ...
        this.pd = P(window, "message", function(b) {
            b = b.ja.data;
            p(b) && 0 == b.indexOf("set-comment-editor-height") && a.W && (a.W.V(),
            a.W = null)
        }))
    }
      , th = function() {
    ...
    var vh = function() {
        ...
        try {
            this.T = ih(".widget.Label"),
            this.T.map(function(a) {
                return a.aa()
            }),
            this.Aa = kh("Label"),
            V(this.a, "Finished initializing labels.")
        } catch (a) {
            U(this.a, "Error initializing labels. Uncaught exception.", a),
            this.b()
        }
    };
    ...
    X.prototype.send = function(a, b, c, d) {
        ...
        this.g.upload && (this.g.upload.onprogress = q(this.Fe, this)));
        try {
        ...
        "withCredentials"in this.g && this.g.withCredentials !== this.jf && (this.g.withCredentials = this.jf);
        try {
            Lh(this),
            0 < this.Wb && (this.Rc = Mh(this.g),
            tf(this.a, Jh(this, "Will abort after " + this.Wb + "ms if incomplete, xhr2 " + this.Rc)),
            this.Rc ? (this.g.timeout = this.Wb,
            this.g.ontimeout = q(this.ff, this)) : this.Oc = qf(this.ff, this.Wb, this)),
            tf(this.a, Jh(this, "Sending request")),
            this.uc = !0,
            this.g.send(a),
            this.uc = !1
        } catch (f) {
            tf(this.a, Jh(this, "Send error: " + f.message)),
            Kh(this, f)
        }
    }
    ;
    ...
    X.prototype.ff = function() {
        "undefined" != typeof na && this.g && (this.Nb = "Timed out after " + this.Wb + "ms, aborting",
        tf(this.a, Jh(this, this.Nb)),
    ...
    X.prototype.abort = function() {
        this.g && this.wa && (tf(this.a, Jh(this, "Aborting")),
        this.wa = !1,
        this.Oa = !0,
        this.g.abort(),
        this.Oa = !1,
                ...
                try {
                    if (Sh(a))
                        ...
                        try {
                            ...
                            tf(a.a, "Can not get status: " + c.message),
                            b = ""
                        }
                        a.Nb = b + " [" + Rh(a) + "]";
                        Nh(a)
    ...
    var Th = function(a, b) {
      ...
      , Sh = function(a) {
        ...
        if (!c) {
            if (b = 0 === b)
                a = String(a.Ob).match(Eh)[1] || null,
                !a && l.self && l.self.location && (a = l.self.location.protocol,
                a = a.substr(0, a.length - 1)),
                b = !Fh.test(a ? a.toLowerCase() : "");
            c = b
        }
        return c
    }
            ...
            for (var b = ba(document.querySelectorAll("img[data-ess]")), c = b.next(); !c.done; c = b.next()) {
                ...
                if (d.srcset) {
                    ...
                    if (!h && f > d.clientWidth) {
                        V(a.a, "Not fetching enchanced sourceset for image " + d.id + " which has a srcset width " + f + ", which is bigger than its size of " + d.clientWidth);
                        return
                    }
                }
                Vh(a, d)
        ...
        b && "video_resize" === b.name && b.iframe_id && dh().then(function(c) {
            if (a.origin === c && (c = document.getElementById(b.iframe_id)))
                if (b.widescreen) {
                    ...
                    c.width = c.getAttribute("data-original-width"),
                    c.height = c.getAttribute("data-original-height")
        })
    }
    ;
 ...
 svg4everybody v2.1.8 | github.com/jonathantneal/svg4everybody */
    ...
    function ki(a) {
        a.onreadystatechange = function() {
            if (4 === a.readyState) {
                var b = a.qf;
                b || (b = a.qf = document.implementation.createHTMLDocument(""),
    ...
    var mi = function() {
        function a() {
            for (var e = 0; e < E.length; ) {
                var f = E[e], h = f.parentNode, k;
                for (k = h; "svg" !== k.nodeName.toLowerCase() && (k = k.parentNode,
                k); )
                    ;
                if (k) {
                    ...
                    if (li() && d) {
                        ...
                        x && (!b.Pg || b.Pg(m, k, f) ? (h.removeChild(f),
                        m = m.split("#"),
                        f = m.shift(),
                        m = m.join("#"),
                        f.length ? (r = y[f],
                        r || (r = y[f] = new XMLHttpRequest,
                        r.open("GET", f),
                        r.send(),
                        r.Ud = []),
                        r.Ud.push({
                        ...
                        ki(r)) : ji(h, k, document.getElementById(m))) : (++e,
                        ++M))
                } else
                    ++e
            }
        ...
        var x = "polyfill"in b ? b.Si : li() ? e.test(navigator.userAgent) || f.test(navigator.userAgent) || 10547 > (navigator.userAgent.match(k) || [])[1] || 537 > (navigator.userAgent.match(h) || [])[1] || m.test(navigator.userAgent) && r : f.test(navigator.userAgent) || 10547 > (navigator.userAgent.match(k) || [])[1] || 537 > (navigator.userAgent.match(h) || [])[1] || m.test(navigator.userAgent) && r;
        var y = {}
    ...
    var pi = function() {
        var a = this;
        l.console && (fi || (fi = new ei),
        l.location && -1 != l.location.href.indexOf("Debug=true") && gi());
        this.Sa = K("blogger.templates.responsive.Template");
        try {
            V(this.Sa, "Initializing responsive template."),
            this.ed = new uh,
            this.archive = new lh,
            ff(this.archive.aa(), function(b) {
                return ni(a, b)
            }),
            this.T = ih(".widget.collapsible"),
            this.labels = new vh,
            Wh(),
            (new nh).replace(),
            oh().replace(),
                ...
                if (b.cssRules)
                    for (var c = 0; c < b.cssRules.length; c++) {
                        ...
                        if (d.style && (d.style.font && -1 != d.style.font.indexOf("Montserrat") || d.style["font-family"] && -1 != d.style["font-family"].indexOf("Montserrat"))) {
                            var e = d.style.cssText.replace("Montserrat", "sans-serif");
                            d.style.cssText = e
                        }
                    }
            }
    ...
    ;var ti = function(a, b) {
        S.call(this);
        a && (this.yc && this.detach(),
        this.c = a,
        this.xc = P(this.c, "keypress", this, b),
        this.ud = P(this.c, "keydown", this.Jb, b, this),
        this.yc = P(this.c, "keyup", this.Pf, b, this))
    };
    t(ti, S);
    g = ti.prototype;
    g.c = null;
    ...
    g.Jb = function(a) {
        ...
        wi && !Qf(a.keyCode, this.P, a.shiftKey, a.ctrlKey, a.altKey, a.metaKey) ? this.handleEvent(a) : (this.ka = Pf(a.keyCode),
        xi && (this.Zc = a.altKey))
    }
    ;
    g.Pf = function(a) {
    ...
    g.handleEvent = function(a) {
        ...
        if (w && "keypress" == a.type) {
            ...
            (A || Lb) && "keypress" == a.type ? (d = this.ka,
            e = 0 <= b.charCode && 63232 > b.charCode && Of(d) ? b.charCode : 0) : Kb && !A ? (d = this.ka,
            e = Of(d) ? b.keyCode : 0) : ("keypress" == a.type ? (xi && (c = this.Zc),
            b.keyCode == b.charCode ? 32 > b.keyCode ? (d = b.keyCode,
            e = 0) : (d = this.ka,
            e = b.charCode) : (d = b.keyCode || this.ka,
            e = b.charCode || 0)) : (d = b.keyCode || this.ka,
            e = b.charCode || 0),
            Nb && 63 == e && 224 == d && (d = 191));
        var f = d = Pf(d);
        d ? 63232 <= d && d in ui ? f = ui[d] : 25 == d && a.shiftKey && (f = 9) : b.keyIdentifier && b.keyIdentifier in vi && (f = vi[b.keyIdentifier]);
        z && wi && "keypress" == a.type && !Qf(f, this.P, a.shiftKey, a.ctrlKey, c, a.metaKey) || (a = f == this.P,
        this.P = f,
        b = new yi(f,e,a,b),
        b.altKey = c,
    ...
    var Ai = function(a, b, c) {
        ...
        this.ia = new De(this);
        a = Ca($d, this.ia);
        this.Ja ? n(void 0) ? a.call(void 0) : a() : (this.Ta || (this.Ta = []),
        this.Ta.push(n(void 0) ? q(a, void 0) : a));
    ...
    Ai.prototype.af = function(a) {
        ...
        if (!this.ie || this.Ka || b && (!(bd ? 0 == a.ja.button : "click" == a.type || a.ja.button & de[0]) || A && Nb && a.ctrlKey))
            ...
            this.ia.w(b, ["touchend", "mouseup"], this.kc, d);
            this.Qc ? (c.setCapture(!1),
            this.ia.w(c, "losecapture", this.kc)) : this.ia.w(Oc(b), "blur", this.kc);
            ...
            this.Sd ? (a = this.target,
            b = a.offsetLeft,
            c = a.offsetParent,
            c || "fixed" != od(a) || (c = C(a).documentElement),
            c ? (z && !$b(58) ? (d = Fd(c),
            b += d.left) : bc(8) && !bc(9) && (d = Fd(c),
            b -= d.left),
            a = zd(c) ? c.clientWidth - (b + a.offsetWidth) : b) : a = b) : a = this.target.offsetLeft;
            this.deltaX = a;
    ...
    Ai.prototype.kc = function(a, b) {
        ...
        this.Qc && this.f.releaseCapture();
        this.Ka ? (this.Ka = !1,
        this.dispatchEvent(new Ci("end",this,a.clientX,a.clientY,a,Di(this, this.deltaX),Ei(this, this.deltaY),b || "touchcancel" == a.type))) : this.dispatchEvent("earlycancel")
    }
    ;
    Ai.prototype.Qf = function(a) {
        if (this.ie) {
            ...
            b = c.x;
            c = c.y;
            this.Ka && this.dispatchEvent(new Ci("beforedrag",this,a.clientX,a.clientY,a,b,c)) && (Gi(this, a, b, c),
            a.preventDefault())
        }
    }
    ;
    ...
    (function() {
        for (var a = ["ms", "moz", "webkit", "o"], b = 0, c; c = a[b] && !l.requestAnimationFrame; ++b)
            l.requestAnimationFrame = l[c + "RequestAnimationFrame"],
            l.cancelAnimationFrame = l[c + "CancelAnimationFrame"] || l[c + "CancelRequestAnimationFrame"];
    ...
    var Hi = [[], []]
      ...
      , Mi = function(a, b) {
        ...
        return function() {
            0 < arguments.length ? (d.S || (d.S = []),
            d.S.length = 0,
            d.S.push.apply(d.S, arguments),
            d.S.push(d.state)) : d.S && 0 != d.S.length ? (d.S[0] = d.state,
            d.S.length = 1) : d.S = [d.state];
            d.vc || (d.vc = !0,
            Hi[Ii].push(d));
            Ji || (Ji = !0,
    ...
    g.N = function() {
        ...
        this.K.className = this.nc() + "-bg",
        I(this.K, !1),
        yd(this.K, 0));
        this.M || (this.M = this.B().N("DIV", this.nc() + "-bg"),
        I(this.M, !1));
        this.ca || (this.ca = this.B().createElement("SPAN"),
        I(this.ca, !1),
        this.ca.tabIndex = 0,
    ...
    g.D = function(a) {
        ...
        a != this.Tc && (this.Xa && this.Xa.stop(),
        this.fb && this.fb.stop(),
        this.Wa && this.Wa.stop(),
    ...
    var Yi = function(a, b) {
        ...
        if (b) {
            ...
            for (var d = c.qa.nd(c.qa.f.body), e = 0; e < d.length; e++) {
                var f = d[e];
                f == c.c || qg(f, "hidden") || (W(f, "hidden", !0),
                c.mb.push(f))
            }
        } else if (c.mb) {
    ...
    Xi.prototype.Hd = function() {
        if (this.dispatchEvent("beforeshow")) {
            ...
            this.focus();
            this.Tc = !0;
            this.Xa && this.fb ? (qe(this.Xa, "end", this.Va, !1, this),
            this.fb.play(),
            this.Xa.play()) : this.Va()
        }
    }
    ;
    Xi.prototype.pb = function() {
        if (this.dispatchEvent("beforehide")) {
            ...
            this.Tc = !1;
            this.Wa && this.eb ? (qe(this.Wa, "end", this.sb, !1, this),
            this.eb.play(),
            this.Wa.play()) : this.sb();
            a: {
                try {
                    var a = this.B()
                      , b = a.f.body
    ...
    var cj = function(a, b) {
      ...
      , dj = function(a, b) {
        ...
        b && !a.za ? (a.za = new Ai(a.h(),a.zb),
        L.addAll(u(a.zb), c),
        P(a.za, "start", a.Ag, !1, a)) : !b && a.za && (a.za.pa(),
        a.za = null)
    };
    g = Z.prototype;
    g.N = function() {
    ...
    var fj = function(a) {
        if (a.oe) {
            var b = a.fa
              , c = b && b.ec;
            c ? (b = b.get(c),
            a.dispatchEvent(new gj(c,b)) && a.D(!1)) : a.D(!1)
        }
    };
    ...
    Z.prototype.Pb = function(a) {
        ...
        if ("keydown" == a.type)
            if (this.Jf && 27 == a.keyCode) {
                ...
                f && !e ? (c = !0,
                b = d.get(f),
                b = this.dispatchEvent(new gj(f,b))) : e || (b = !0)
            } else {
            ...
            f && d && (c = !0,
            b = this.dispatchEvent(new gj(f,String(d.get(f)))))
        } else
    ...
    "undefined" != typeof document && (Y(new $i, aj, !0, !0),
    Y(Y(new $i, aj, !0), bj, !1, !0),
    Y(Y(new $i, ij, !0), jj, !1, !0),
    Y(Y(Y(new $i, ij), jj, !0), bj, !1, !0),
    Y(Y(Y(new $i, lj), kj), bj, !0, !0));
    var nj = function() {
        ...
        try {
            ...
            U(this.a, "Error initializing sharing. Uncaught exception.", c),
            this.b()
        }
    }
      , mj = function(a) {
        eh("sharing_native").then(function(b) {
            for (var c = {}, d = ba(Array.prototype.slice.call(document.querySelectorAll(".sharing"), 0)), e = d.next(); !e.done; c = {
                F: c.F,
                Ga: c.Ga,
                da: c.da,
                va: c.va,
            ...
            e = d.next())
                if (c.Ga = e.value,
                c.R = F("sharing-button", c.Ga),
                c.va = F("share-buttons-container", c.Ga),
                c.da = F("share-buttons", c.Ga),
                c.va && c.da && c.R) {
                    c.F = new Gg(c.da);
                    e = function(a) {
                        return function() {
                    ...
                    W(c.R, "expanded", !1);
                    W(c.R, "haspopup", !0);
                    b && void 0 !== navigator.share && (c.Bb = F("sharing-element-other", c.Ga),
                    f = c.Bb.parentElement,
                    L.remove(f, "hidden"),
                    f.removeAttribute("aria-hidden"),
                    P(c.Bb, "click", function(b) {
                        return function() {
    ...
    nj.prototype.xb = function(a, b, c, d) {
        ...
        a.D(!1),
        L.add(d, "sharing-open"),
        L.remove(b, "hidden"),
        W(b, "expanded", !0),
        W(b, "hidden", !1),
        c = "ltr" == l.document.documentElement.getAttribute("dir") ? 4 : 0,
        a.Bd = c,
        a.I() && a.L(),
        d && (W(d, "expanded", !0),
        a.setPosition(new Sg(d,c))),
        a.D(!0),
        this.i.he && (this.j = Nf(document.body, null, "sharing-dim-overlay"),
        this.j.show()),
        oj(this, b))
    }
    ;
    nj.prototype.nb = function(a, b, c, d) {
        b && c && (L.remove(d, "sharing-open"),
        L.add(b, "hidden"),
        W(b, "expanded", !1),
        W(b, "hidden", !0),
    ...
    nj.prototype.Pb = function(a, b, c, d, e) {
        b && c && (38 == e.keyCode || 40 == e.keyCode) && (a.I() || this.xb(a, b, c, d),
        a = Array.prototype.slice.call(b.querySelectorAll("." + this.i.Ve)),
                        ...
                        if (L.contains(c, "sharing-element-link"))
                            ...
                            var f = function() {
                                ...
                                if (f instanceof rc)
                                    ...
                                    h = "undefined" != typeof f.href ? f.href : String(f),
                                    h instanceof rc || (h = "object" == typeof h && h.Na ? h.Ma() : String(h),
                                    tc.test(h) || (h = "about:invalid#zClosurez"),
                                    h = uc(h));
                                f = a.target || f.target;
                                var k = [];
                                for (m in a)
                                ...
                                if (Fb() && e.navigator && e.navigator.standalone && f && "_self" != f) {
                                    ...
                                    if ("undefined" != typeof k.HTMLAnchorElement && "undefined" != typeof k.Location && "undefined" != typeof k.Element) {
                                        ...
                                        var r = ua(m) ? m.constructor.displayName || m.constructor.name || Object.prototype.toString.call(m) : void 0 === m ? "undefined" : null === m ? "null" : typeof m;
                                        u(k, "Argument is not a %s (or a non-Element, non-Location mock); got: %s", "HTMLAnchorElement", r)
                                    }
                                    h instanceof rc || h instanceof rc || (h = "object" == typeof h && h.Na ? h.Ma() : String(h),
                                    u(tc.test(h), "%s does not match the safe URL pattern", h) || (h = "about:invalid#zClosurez"),
                                    h = uc(h));
                                    m.href = sc(h);
                                    ...
                                    a.noreferrer ? (e = e.open("", f, m),
                                    h = sc(h),
                                    e && (Mb && -1 != h.indexOf(";") && (h = "'" + h.replace(/'/g, "%27") + "'"),
                                    e.opener = null,
                                    a = new kc(ic,"b/12014412, meta tag with sanitized URL"),
                                    h = '<meta name="referrer" content="no-referrer"><meta http-equiv="refresh" content="0; url=' + lb(h) + '">',
                                    Ma(lc(a), "must provide justification"),
                                    u(!/^[\s\xa0]*$/.test(lc(a)), "must provide non-empty justification"),
                                    a = yc(h, null),
                                    e.document.write(xc(a)),
                                    e.document.close())) : (e = e.open(sc(h), f, m)) && a.noopener && (e.opener = null);
                                d();
                                return !1
                            };
                            P(e, "key", function(a) {
            ...
            c.on("success", function() {
                ...
                eh("sharing_get_link_dialog").then(function(b) {
                    if (b && 0 <= qi()) {
                        ...
                        c.fa = f;
                        c.ea && (c.fa ? ej(c.fa, c.ea) : Cc(c.ea, zc),
                        I(c.ea, !!c.fa));
                        c.Te(a);
                        c.ge = !1;
                        dj(c, !1);
    ...
    var qj = function() {
        ...
        try {
            ...
            if (b) {
                ...
                U(this.a, "There was an error initializing the sidebar toggle section. sidebar not found.")
        } catch (d) {
            U(this.a, "Error initializing sidebar toggle. Uncaught exception.", d),
            this.b()
        }
    };
    qj.prototype.Qd = function() {
        ri(this.Kd)();
        L.contains(this.Kd, "sidebar-invisible") ? (this.j && this.j.Lb(),
        L.remove(document.body, "sidebar-visible")) : (this.j && this.j.show(),
        L.add(document.body, "sidebar-visible"))
    }
    ;
    ...
    var sj = function() {
        ...
        try {
            this.i = new rj,
            this.ma = new Og(new Ng(this.i.Db,this.i.hb,function(b, c) {
                return a.Ec(b, c)
            }
            )),
            V(this.a, "Finished initializing Snippets.")
        } catch (b) {
            U(this.a, "Error initializing Snippets. Uncaught exception.", b),
            this.b()
        }
    };
    ...
    var tj = function(a) {
        ...
        try {
            ...
            U(this.Sa, "Error initializing indie template. Uncaught exception.", c),
            this.b()
        }
    };
    ja(tj, pi);
